...
\frame{
	...
	Copy and modify existing Shiny apps !
	\begin{itemize}
		\item Eleven pre-built Shiny examples: http://shiny.rstudio.com/tutorial/lesson1/\#Go Further
		...
		\item Gallery: http://shiny.rstudio.com/gallery/
