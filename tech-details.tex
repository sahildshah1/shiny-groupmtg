...
\frame{
	...
	`Hello Shiny' Example
	\begin{itemize}
		\item fluidPage, sidebarLayout $\rightarrow$ Define layout
	\end{itemize}

	
	Place widgets (eg. slider) and R objects (eg. plot) in layout
	\begin{itemize}
		\item widgets: *Input functions: tutorial/lesson3
		\item widget label : Access widget value
		\item R objects: *Output functions: tutorial/lesson4
		\itme R object: *Output function argument : match label in server.R
	\end{itemize}
